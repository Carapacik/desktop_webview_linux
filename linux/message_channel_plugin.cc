...
namespace {
    ...
    ClientMessageChannelPlugin::ClientMessageChannelPlugin(FlMethodChannel *channel) : channel_(
            channel) {
    ...
    void client_plugin_proxy_dispatch_method_call(FlMethodChannel *channel, FlMethodCall *call,
                                                  gpointer user_data) {
